...
class PretextTaskTrainer(BaseTrainer):
    ...
    def __init__(self, config: Dict):
        ...
        h_size = 512  # size of the h feature space
    ...
    def train(self) -> NoReturn:
        ...
        checkpoint_folder = Path(self._writer.log_dir) 
        ...
        for epoch_counter in range(1, self._config['epochs'] + 1):
            ...
            if epoch_counter >= 10:
                scheduler.step()
            #self._writer.add_scalar('cosine_lr_decay', scheduler.get_last_lr()[0], global_step=n_iter)
            #torch.save(model.state_dict(), checkpoint_folder / f'model_{epoch_counter}.pth')
